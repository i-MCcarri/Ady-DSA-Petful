    ...
    render() {
        ...
        <div id='splash'>
            <div>
                ...
                <ol><li>First, view all of our <a href="/pets"><span class="s1">pet profiles</span></a> and identify the available pet you wish to bring home.</li><li>Then fill out and submit one of the pre-adoption applications below and include the type of the pet you wish to have join your family. A team member will go over the pet’s specific needs with you during an initial call, to see if you would be a good match.</li></ol>
                ...
                <p>* A fee is required to place a hold.</p>
